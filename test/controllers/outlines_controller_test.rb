...
class OutlinesControllerTest < ActionController::TestCase
  ...
  test "should create outline" do
    assert_difference('Outline.count') do
      post :create, outline: { action: @outline.action, goals: @outline.goals, responsibilities: @outline.responsibilities, roles: @outline.roles, timeline: @outline.timeline }
    end
  ...
  test "should update outline" do
    patch :update, id: @outline, outline: { action: @outline.action, goals: @outline.goals, responsibilities: @outline.responsibilities, roles: @outline.roles, timeline: @outline.timeline }
    assert_redirected_to outline_path(assigns(:outline))
  end
